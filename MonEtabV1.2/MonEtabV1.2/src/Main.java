...
// Vérifier la connexion à la base de données
        SocketChannel SingletonDataBase = null;
        if (SingletonDataBase.isConnected()) {// Boucle d'authentification
            while (!authenticated) {
    ...
    private static void afficherTableauDeBord() {
        // Code pour afficher l'écran de tableau de bord
        System.out.println("Affichage du tableau de bord...");
        // Vous pouvez remplacer ceci par le code réel pour afficher le tableau de bord
    }
}
